...
from flask import render_template, Blueprint,json, url_for, \
...
@user_blueprint.route('/api/register', methods=['GET', 'POST'])
def apiregister():
    data = {}
...
@user_blueprint.route('/api/login', methods=['GET', 'POST'])
def apilogin():
    if request.headers['Content-Type'] == 'application/json':
